...
def seed_stocks():
    ...
    msft = Stock(name='Microsoft', symbol='MSFT', current_price=14.90, company_info='Microsoft Corp. engages in the development and support of software, services, devices, and solutions. It operates through the following business segments: Productivity and Business Processes, Intelligent Cloud, and More Personal Computing.')
